...
//#define Serial_PutString(...) (void)0
/* Private functions ---------------------------------------------------------*/
...
//  FlashProtection = FLASH_If_GetWriteProtectionStatus();
  ...
  while (1)
  {
    ...
    Serial_PutString("\r\n=================== Main Menu ============================\r\n\n");
    Serial_PutString("  Download image to the internal Flash  \r\n\n");
